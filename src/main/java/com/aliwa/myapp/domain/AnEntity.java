...
public class AnEntity implements Serializable {
    ...
    public AnEntity aString(String aString) {
    ...
    public AnEntity aInteger(Integer aInteger) {
    ...
    public AnEntity aLong(Long aLong) {
        this.setaLong(aLong);
        return this;
    }
    ...
    public AnEntity aBigDecimal(BigDecimal aBigDecimal) {
    ...
    public AnEntity aFloat(Float aFloat) {
    ...
    public AnEntity aDouble(Double aDouble) {
    ...
    public AnEntity aEnum(AEnum aEnum) {
        this.setaEnum(aEnum);
        return this;
    }
    ...
    public AnEntity aBoolean(Boolean aBoolean) {
    ...
    public AnEntity aLocalDate(LocalDate aLocalDate) {
    ...
    public AnEntity aZonedDateTime(ZonedDateTime aZonedDateTime) {
    ...
    public AnEntity aInstant(Instant aInstant) {
    ...
    public AnEntity aDuration(Duration aDuration) {
    ...
    public AnEntity aUUID(UUID aUUID) {
        this.setaUUID(aUUID);
        return this;
    }
    ...
    public AnEntity aBlob(byte[] aBlob) {
        this.setaBlob(aBlob);
        return this;
    }
    ...
    public AnEntity aBlobContentType(String aBlobContentType) {
    ...
    public AnEntity aAnyBlob(byte[] aAnyBlob) {
    ...
    public AnEntity aAnyBlobContentType(String aAnyBlobContentType) {
    ...
    public AnEntity imageBlob(byte[] imageBlob) {
    ...
    public AnEntity imageBlobContentType(String imageBlobContentType) {
    ...
    public AnEntity aTextBlob(String aTextBlob) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AnEntity)) {
            return false;
        }
        return id != null && id.equals(((AnEntity) o).id);
    }
