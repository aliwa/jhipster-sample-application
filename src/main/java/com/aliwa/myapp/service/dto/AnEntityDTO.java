...
/**
 * A DTO for the {@link com.aliwa.myapp.domain.AnEntity} entity.
 */
public class AnEntityDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AnEntityDTO)) {
            return false;
        }

        AnEntityDTO anEntityDTO = (AnEntityDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, anEntityDTO.id);
    }
