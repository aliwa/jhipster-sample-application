...
import com.aliwa.myapp.domain.Employee;
import com.aliwa.myapp.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.aliwa.myapp.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
