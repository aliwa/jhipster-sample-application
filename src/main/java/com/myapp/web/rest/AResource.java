...
public class AResource {
    ...
    public ResponseEntity<A> partialUpdateA(@PathVariable(value = "id", required = false) final Long id, @NotNull @RequestBody A a)
        ...
        Optional<A> result = aRepository
            .findById(a.getId())
            .map(existingA -> {
                if (a.getaString() != null) {
                    existingA.setaString(a.getaString());
                }
                if (a.getaInteger() != null) {
                    existingA.setaInteger(a.getaInteger());
                }
                if (a.getaLong() != null) {
                    existingA.setaLong(a.getaLong());
                }
                if (a.getaBigDecimal() != null) {
                    existingA.setaBigDecimal(a.getaBigDecimal());
                }
                if (a.getaFloat() != null) {
                    existingA.setaFloat(a.getaFloat());
                }
                if (a.getaDouble() != null) {
                    existingA.setaDouble(a.getaDouble());
                }
                if (a.getaEnum() != null) {
                    existingA.setaEnum(a.getaEnum());
                }
                if (a.getaBoolean() != null) {
                    existingA.setaBoolean(a.getaBoolean());
                }
                if (a.getaLocalDate() != null) {
                    existingA.setaLocalDate(a.getaLocalDate());
                }
                if (a.getaZonedDateTime() != null) {
                    existingA.setaZonedDateTime(a.getaZonedDateTime());
                }
                if (a.getaInstant() != null) {
                    existingA.setaInstant(a.getaInstant());
                }
                if (a.getaDuration() != null) {
                    existingA.setaDuration(a.getaDuration());
                }
                if (a.getaUUID() != null) {
                    existingA.setaUUID(a.getaUUID());
                }
                if (a.getaBlob() != null) {
                    existingA.setaBlob(a.getaBlob());
                }
                if (a.getaBlobContentType() != null) {
                    existingA.setaBlobContentType(a.getaBlobContentType());
                }
                if (a.getaAnyBlob() != null) {
                    existingA.setaAnyBlob(a.getaAnyBlob());
                }
                if (a.getaAnyBlobContentType() != null) {
                    existingA.setaAnyBlobContentType(a.getaAnyBlobContentType());
                }
                if (a.getImageBlob() != null) {
                    existingA.setImageBlob(a.getImageBlob());
                }
                if (a.getImageBlobContentType() != null) {
                    existingA.setImageBlobContentType(a.getImageBlobContentType());
                }
                if (a.getaTextBlob() != null) {
                    existingA.setaTextBlob(a.getaTextBlob());
                }
