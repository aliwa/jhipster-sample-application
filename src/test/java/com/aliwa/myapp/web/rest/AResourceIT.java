...
class AResourceIT {
    ...
    void createA() throws Exception {
        ...
        restAMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(aDTO)))
    ...
    void putNewA() throws Exception {
        ...
        restAMockMvc
            .perform(
                put(ENTITY_API_URL_ID, aDTO.getId())
    ...
    void putWithMissingIdPathParamA() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(aDTO)))
    ...
    void patchNonExistingA() throws Exception {
        ...
        restAMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, aDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(aDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamA() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(aDTO)))
            .andExpect(status().isMethodNotAllowed());
