...
class EntityTestResourceIT {
    ...
    void createEntityTest() throws Exception {
        ...
        restEntityTestMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entityTest)))
    ...
    void putNewEntityTest() throws Exception {
        ...
        restEntityTestMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedEntityTest.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedEntityTest))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingEntityTest() throws Exception {
        ...
        restEntityTestMockMvc
            .perform(
                put(ENTITY_API_URL_ID, entityTest.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(entityTest))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamEntityTest() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEntityTestMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(entityTest)))
    ...
    void patchNonExistingEntityTest() throws Exception {
        ...
        restEntityTestMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, entityTest.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(entityTest))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamEntityTest() throws Exception {
        ...
        restEntityTestMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(entityTest))
            )
            .andExpect(status().isMethodNotAllowed());
